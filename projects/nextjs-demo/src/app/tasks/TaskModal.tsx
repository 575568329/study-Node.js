...
export default function TaskModal({ task, onClose,tags,onSuccess }: TaskModalProps) {
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex gap-4 mb-4">
            <div className="flex-1">
              ...
              <select {...register('tag_id', { valueAsNumber: true })} className="w-full p-2 border border-gray-300 rounded">
