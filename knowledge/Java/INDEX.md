...
- [Day14 - Spring事务 @Transactional](./Day14-Spring事务-Transactional.md) ⚠️ 事务=AOP切面/回滚规则/三大失效场景/传播行为（验证未过，需重学AOP代理）
...
| Week 4 | Spring 框架 | 🔄 进行中（Day12 IoC/DI/MVC ✅、Day13 AOP/Bean生命周期 ✅、Day14 事务 ⚠️需重学AOP代理）|
