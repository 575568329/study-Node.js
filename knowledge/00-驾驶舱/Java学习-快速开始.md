...
3. [`Java学习路径-稳扎稳打版.md`](Java学习路径-稳扎稳打版.md) - 完整 4-5 个月计划
4. [`技能优先级-运维技能版.md`](技能优先级-运维技能版.md) - Linux/Docker/K8s 优先级判断
5. [`todo.md`](../todo.md) - 待办清单
6. [`latest-session.md`](../latest-session.md) - 上次学习记录
...
- [ ] 输出《Java vs Node.js 语法对比.md》到 `knowledge/java/`
