...
| 阶段 | 主题 | 状态 |
|------|------|------|
| R1 | React 核心概念（JSX/组件/Props/条件列表渲染） | ✅ 已完成 |
...
### 01-知识点总结
- [JSX 语法](01-知识点总结/JSX语法.md)
- [函数组件](01-知识点总结/函数组件.md)
- [Props 与 TypeScript](01-知识点总结/Props与TypeScript.md)
- [条件渲染与列表渲染](01-知识点总结/条件渲染与列表渲染.md)
- [useState 状态管理](01-知识点总结/useState.md)
- [useEffect 副作用处理](01-知识点总结/useEffect.md)
- [useRef 引用管理](01-知识点总结/useRef.md)
- [useMemo 与 useCallback](01-知识点总结/useMemo与useCallback.md)
- [useContext 跨组件通信](01-知识点总结/useContext.md)
- [useReducer 复杂状态管理](01-知识点总结/useReducer.md)
- [自定义 Hook](01-知识点总结/自定义Hook.md)
...
### 05-速查表
- [Vue3 to React 速查表](05-速查表/Vue3-to-React速查表.md)
